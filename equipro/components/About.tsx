        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-blue-900/20">
              <img
                src="/images/co2-nh3-cascade.jpg"
                alt="Equipro Engineering Team at Work"
                className="w-full h-[480px] object-cover"
                loading="lazy"
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-[#0d2561]/25 to-transparent" />
            </div>
            {/* Floating card */}
            <motion.div
              className="absolute -bottom-6 -right-6 bg-[#0d2561] text-white p-6 rounded-xl shadow-xl max-w-[200px]"
            ...
            >
              ...
              <div className="text-blue-200 text-sm">Years of Engineering Excellence</div>
            </motion.div>
            {/* Red accent */}
            <div className="absolute -top-4 -left-4 w-20 h-20 bg-[#c8102e]/10 rounded-xl -z-10" />
          </motion.div>
          ...
          <motion.div
            ...
            transition={{ duration: 0.8, ease: "easeOut" }}
          >
            <span className="inline-block text-[#c8102e] text-xs font-bold tracking-widest uppercase mb-3">Who We Are</span>
            <h2 className="text-4xl md:text-5xl font-bold text-[#0d2561] mb-6 leading-tight" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
              About<br /><span className="text-[#c8102e]">Equipro Group</span>
            </h2>
            ...
            <div className="flex gap-8 mb-8 pt-6 border-t border-gray-200">
              {stats.map((s) => (
                <div key={s.label} className="text-center">
                  <s.icon size={20} className="text-[#c8102e] mx-auto mb-1" />
                  <div className="font-bold text-[#0d2561] text-lg" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>{s.value}</div>
            ...
            <Link
              href="/about-us"
              className="inline-flex items-center gap-2 bg-[#0d2561] hover:bg-[#c8102e] text-white font-semibold px-7 py-3.5 rounded-xl transition-all duration-200 shadow-lg"
            >
              ABOUT US
            </Link>
          </motion.div>
