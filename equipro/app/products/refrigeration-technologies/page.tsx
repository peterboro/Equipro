...
const technologies = [
  {
    ...
    tagColor: "#1a3a8c",
    image: "/images/freon-refrigeration-system.png",
  ...
  },
  {
    ...
    tagColor: "#0d7a3e",
    image: "/images/co2-refrigeration-system.png",
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-3 gap-12">
            ...
            <div className="lg:col-span-2">
              ...
              <h2 className="text-3xl font-bold text-[#0d2561] mb-5" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
              ...
              <div className="space-y-10">
                {technologies.map((tech) => (
                  <div key={tech.name} className="bg-[#f7f9fc] rounded-2xl overflow-hidden border border-gray-100 shadow-sm">
                    <div className="relative h-64 overflow-hidden">
                      <img
                        ...
                        loading="lazy"
                      />
                      <div className="absolute inset-0 bg-gradient-to-t from-[#0d2561]/70 to-transparent" />
                      ...
                      <ul className="grid grid-cols-2 gap-2">
                        {tech.specs.map((s) => (
                          <li key={s} className="flex items-center gap-2 text-[13px] text-gray-700">
                            <CheckCircle2 size={14} className="flex-shrink-0" style={{ color: "#c8102e" }} />
                            {s}
                          </li>
                        ))}
                      </ul>
              ...
              {/* F-Gas image */}
              <div className="mt-10">
                <h3 className="text-2xl font-bold text-[#0d2561] mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>
                  F-Gas Regulation Compliance
                </h3>
                <div className="relative rounded-2xl overflow-hidden shadow-lg h-64 mb-4">
                  <img src="/images/fgas.jpg" alt="F-Gas Regulation" className="w-full h-full object-cover" loading="lazy" />
                  <div className="absolute inset-0 bg-gradient-to-r from-[#0d2561]/60 to-transparent" />
              ...
              <div className="mt-8">
                ...
                <div className="rounded-2xl overflow-hidden shadow-lg h-56">
                  <img src="/images/glycol.jpg" alt="Glycol Refrigeration System" className="w-full h-full object-cover" loading="lazy" />
                </div>
            ...
            <div className="space-y-6">
              <div className="bg-[#f7f9fc] rounded-2xl p-6 border border-gray-100">
                ...
                <ul className="space-y-1">
                  {allProducts.map((p) => (
                    <li key={p.href}>
                      <Link href={p.href}
                        className={`block px-4 py-2.5 rounded-lg text-sm transition-all ${p.title === "Refrigeration Technologies" ? "text-white font-semibold" : "text-gray-600 hover:bg-white hover:text-[#0d2561] hover:shadow-sm"}`}
                        style={p.title === "Refrigeration Technologies" ? { background: "#0d2561" } : {}}>
                        {p.title}
                      </Link>
                    </li>
                  ))}
              ...
              <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm">
                <h4 className="font-bold text-[#0d2561] text-lg mb-4" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>Quick Comparison</h4>
              ...
              <div className="rounded-2xl p-6 text-white" style={{ background: "#0d2561" }}>
                ...
                <p className="text-blue-200 text-sm leading-relaxed mb-5">Not sure which refrigerant technology is right for your project? Our engineers will help you choose.</p>
