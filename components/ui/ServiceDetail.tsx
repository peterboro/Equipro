        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <h3 className="text-2xl font-bold text-[#0d2561] mb-4" style={{ fontFamily:"'Barlow Condensed',sans-serif" }}>Key Features & Benefits</h3>
              ...
              {specs && (
                <>
                  <h3 className="text-2xl font-bold text-[#0d2561] mb-4" style={{ fontFamily:"'Barlow Condensed',sans-serif" }}>Technical Details</h3>
            ...
            <div className="space-y-6">
              <div className="bg-[#f7f9fc] rounded-2xl p-6 border border-gray-100">
                <h4 className="font-bold text-[#0d2561] text-lg mb-4" style={{ fontFamily:"'Barlow Condensed',sans-serif" }}>All Services</h4>
                <ul className="space-y-1">
                  {allServices.map((s) => (
                    <li key={s.href}>
                      <Link href={s.href} className={`block px-4 py-2.5 rounded-lg text-sm transition-all ${s.title === title ? "text-white font-semibold" : "text-gray-600 hover:bg-white hover:text-[#0d2561] hover:shadow-sm"}`}
                        style={s.title === title ? { background: "#0d2561" } : {}}>
                        {s.title}
                      </Link>
                    </li>
                  ))}
              ...
              <div className="rounded-2xl p-6 text-white" style={{ background: "#0d2561" }}>
                ...
                <p className="text-blue-200 text-sm leading-relaxed mb-5">Our engineers are ready to design a system tailored to your exact requirements.</p>
