      ...
      <>
        ...
        <section className="py-20 bg-white">
          <div className="max-w-4xl mx-auto px-6 text-center">
            ...
            <Link href="/blog-news" className="inline-flex items-center gap-2 text-[#c8102e] font-semibold">Back to Blog <ArrowLeft size={14} /></Link>
          </div>
        </section>
        <Footer />
      </>
    ...
    <>
      ...
      <section className="py-16 bg-white">
        <div className="max-w-5xl mx-auto px-6">
          <div className="mb-8">
            <Link href="/blog-news" className="text-sm text-gray-500 hover:text-[#0d2561]">← Back to Blog</Link>
          </div>

          <article className="prose lg:prose-xl">
            <h1 className="text-[#0d2561]">{post.title}</h1>
